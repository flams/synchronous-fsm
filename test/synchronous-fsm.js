...
describe("StateMachineTest", function () {
    ...
    it("should create a state machine with the correct API", function () {
        ...
        expect(typeof stateMachine.add).toBe("function");
        expect(typeof stateMachine.get).toBe("function");
        expect(typeof stateMachine.init).toBe("function");
        expect(typeof stateMachine.getCurrent).toBe("function");
        expect(typeof stateMachine.event).toBe("function");
    });
...
describe("StateMachineTransition", function () {
    ...
    it("should have the following api", function () {
        ...
        expect(typeof state.event).toBe("function");
